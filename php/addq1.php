...
if($das==0 && isset($_POST['type'],$_POST['subj'],$_POST['class'],$_POST['topic'],$_POST['q'],$_POST['ch'],$_POST['qrnk'],$_POST['axsn'],$_POST['tstbnk'],$_POST['subtopic'],$_POST['sch_topic'])){
    ...
    $sch_topic=0;
    $tstbnk=intval($_POST['tstbnk']);
    if($tstbnk==1){
        $topic=0;
    }
    if($tstbnk==2) $sch_topic=intval($_POST['sch_topic']);
