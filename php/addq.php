...
if($das==0 && isset($_POST['type'],$_POST['subj'],$_POST['class'],$_POST['ristvis'],$_POST['topic'],$_POST['q'],$_POST['ch'],$_POST['qrnk'],$_POST['axsn'],$_POST['subtopic'])){
    ...
    $query="INSERT INTO questions (type,subject,class,topic,subtopic,sch_topic,statement,choices,qrnk,axsna,author,ristvis,addedTime{$dmtvrb}) VALUES('{$type}','{$subj}',{$class},{$topic},{$subtopic},{$sch_topic},'{$quest}','{$chc}',{$qrnk},'{$axsn}',{$id},{$ristvis},{$timee}{$dmtvls})";
