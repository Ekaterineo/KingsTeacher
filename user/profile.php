...
<body class="bodylogin">
	<!--<div class="toppage">
		<div class="logout logbotbut" onclick="location.href='home.php'"> მთავარი</div>
		<div class="logout logbotbut" onclick="location.href='../logout.php'"> გასვლა</div> <br> <br>
	</div>-->
	<div class="main">
		...
		<div class="lgcont">
			<div class="logtop" style="margin-top:75px"> პროფილი </div>
			<div class="logbox">
				...
				<?php for($i=1; $i<count($cities)+4; $i++) if($cities[$i][0]!=''){if($user['city']==$cities[$i][0]) $dmt='selected="true"'; else $dmt=''; echo "<option {$dmt} value='{$cities[$i][0]}'>{$cities[$i][1]}</option>";} if($user['city']==250) $dmt='selected="true"'; else $dmt=''; echo "<option {$dmt} value='250'>სხვა</option>"; ?> 
				</select><br/><br>
			...
			<button class="logbotbut regbutton" tabindex="-1" onclick="rgcheckk(2)" >
				ცვლილებების შენახვა
			</button>
			<br>
			<br>
		...
		<div class="lgcont">
			<br>
			<div class="logtop" style="margin-top:20px"> პაროლის შეცვლა </div>
			<div>
				<input type="password" class="pale" id="passwordold" placeholder="პაროლი" style="font-size: 18px; width: 100%" autocomplete="off">
				<input type="password" class="pale" id="password" placeholder="ახალი პაროლი" style="font-size: 18px; width: 100%" autocomplete="off">
				<input type="password"  class="pale" id="password2" placeholder="გაიმეორეთ ახალი პაროლი" autocomplete="off">

				<button class="logbotbut regbutton" tabindex="-1" onclick="updpassword()" > პაროლის შენახვა </button>
				<br> <br> <br>
			</div>
	...
	<script>
		$(document).ready(function(){
			//console.log("school=",<?php echo $user['school'];?>);
			...
			//console.log("city=$",$('#slccity option:selected').val(),"school=",<?php echo $user['school'];?>)
			...
			$('#slcschool').change(function(){
					ldschool($('#slccity').val(),$('#slcschool option:selected').val());
					//$('#slcschool').selectpicker('refresh');
